...
public class MainMenuVik : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        playerPassword = GUILayout.TextField(playerPassword);
        ...
        if (GUILayout.Button("GO"))
        {
            ...
            // receive (does it exist = "true/false", username="", password="")
            // if(doesitexist)
            // check password with recieved message
            // if correct -> join room
            PhotonNetwork.JoinRoom(roomName);
            // else 
            // prompt that new account with username/password has been created ->using print first
        }
        GUILayout.EndHorizontal();
